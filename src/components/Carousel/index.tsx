...
const IMG = [
  {
    ...
    paragraph1:
      '요가, 러닝, 피트니스 등 여러 운동을 통해 건강을 챙기며, 함께하는 사람들과',
  ...
  },
  {
    ...
    paragraph1:
      '모임에서 취미활동 뿐만 아니라 함께 공부할 수 있는 시간도 있어요!',
  ...
  },
  {
    ...
    paragraph1:
      '팀을 이뤄 협동 게임에 도전하거나, 간단한 보드게임으로 즐거운 경쟁을 펼쳐보세요.',
      ...
      <div className="overflow-hidden rounded-2xl">
        <div className={`flex ${transition && 'transition-transform duration-500'}`} style={{ transform: `translateX(-${current * 100}%)` }}>
          {extendedImg.map((img, index) => (
            <div key={index} className="flex w-full shrink-0 flex-col justify-between rounded-2xl text-white">
              <Image src={img.src} alt={img.alt} width={1200} height={300} />
