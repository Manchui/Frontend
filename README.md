# 만취
- 만취는 취미가 같은 사람들과 함께 즐거운 시간을 보낼 수 있는 모임 플랫폼입니다.
<img width="924" alt="스크린샷 2025-02-01 오후 5 03 13" src="https://github.com/user-attachments/assets/ab15a462-651f-44d0-8837-fb53219dcef9" />
...
### [프로젝트 소개]
  - 만취는 만명이 함께하는 취미활동을 위한 모임 플랫폼입니다.
...
#### ⭐ 알림 시스템
- 새로운 참여자 알림, 모임 찡하기, 채팅 메시지 등 중요한 업데이트를 실시간으로 받아볼 수 있습니다.
